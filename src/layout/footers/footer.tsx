...
const footer_data: footerThreeContentItem[] = [
  {
    id: 1,
    title: "About",
    cls: "col-xl-2",
...
type copyrightType = {
  logo: string;
  copyright_text: React.ReactNode;
};
        ...
        >
          <div className="f-border pt-115 pb-70">
            <div className="container">
              <div className="row">
                {footer_data.map((item: footerThreeContentItem) => (
                  <div key={item.id} className={`${item.cls} col-md-4`}>
                    <div className={`footer-widget ${item.footer_col} mb-50`}>
                      ...
                      <div className="footer-widget__link">
                        <ul>
                          {item.links.map((link: SocialLinkItem, i: number) => (
                            <li key={i}>
                              <a href="#">{link.name}</a>
                            </li>
                          ))}
