...
// choose_data_3
const choose_data_3: ChooseDataItem[] = [
  {
    id: 1,
...
type chooseTopDataType = {
  title: string;
  des: React.ReactNode;
};
// choose top data
const choose_top_data: chooseTopDataType = {
  title: "Why You Choose Our E-Pora Online learning",
  des: (
    <>
      {" "}
      Competently facilitate end-to-end testing procedure before customized
      applications. Interactively coordinate scalable.
    </>
  ),
};
            ...
            <div className="col-xl-5 col-lg-6 col-md-12">
              <div className="tp-choose-content mb-50">
                <div className="section-title mb-30">
                  ...
                  <h2 className="tp-section-title mb-35">{title}</h2>
                  <p>{des}</p>
                </div>
                <div className="tp-choose-online-list">
                  <ul>
                    {choose_data_3.map((item: ChooseDataItem, i: number) => (
                      <li key={i}>
