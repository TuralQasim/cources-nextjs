...
const BlogMasonryArea: React.FC = () => {
  return (
    <>
      <section className="blog-area pt-110 pb-115">
        <div className="container">
          ...
          <div className="row mb-20">
            {blog_masonry_data.map((item: blogMasonryDataItem, i: number) => (
              <div key={i} className="col-lg-4 col-md-6">
                ...
                >
                  ...
                  <div className="tp-blog__content blog-box p-relative">
                    ...
                    <p>{item.des}</p>
                    <span>
                      <i className="fi fi-rr-clock"></i> {item.post_time}
                    </span>
                  </div>
                </div>
              </div>
