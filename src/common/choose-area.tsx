...
const choose_data: chooseDataType = {
  ...
  des: (
    <>
      Dramatically supply transparent deliverables before & you backward comp
...
type ChooseListDataItem = {
  list: string;
};
// choose list data
const choose_list_data: ChooseListDataItem[] = [
  {
...
const ChooseArea: React.FC<ChooseAreaProps> = ({ style_about, style_2 }) => {
  return (
    <>
      <section
        className={`choose-area bg-bottom ${
          style_about ? "pb-120" : "grey-bg"
        } ${style_2 ? "pt-120 pb-90" : ""} wow fadeInUp`}
        data-wow-duration=".8s"
        data-wow-delay=".4s"
        style={{
          backgroundImage: style_about
            ? null
            ...
            <div className="col-xl-5 col-lg-6 col-md-12">
              <div className="tp-choose-content mb-30">
                ...
                <div className="tp-choose-list tp-choose-bg mb-60">
                  <ul>
                    {choose_list_data.map(
                      (item: ChooseListDataItem, i: number) => (
                        <li key={i}>
