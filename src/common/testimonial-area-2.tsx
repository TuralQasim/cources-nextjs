...
// testimonial_data_3
const testimonial_data_3: testimonialDataItem[] = [
  {
    id: 1,
    name: "Wade Warren",
...
type TestimonialAreaThreeProps = {
  style_about: boolean;
};
const TestimonialAreaThree: React.FC<TestimonialAreaThreeProps> = ({
  style_about,
}) => {
  return (
    <>
      <section
        className={`testimonial-area bg-bottom ${
          style_about ? "pt-120" : "pt-115"
        } pb-90  wow fadeInUp`}
      ...
      >
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title text-center mb-65">
                <span
                  className={`${
                    style_about ? "tp-sub-title-box" : "tp-bline-stitle"
                  } mb-15`}
                >
                  Testimonial
                </span>
          ...
          <div className="testimonial-active-box tp-slide-space-white">
            <Slider {...setting}>
              {testimonial_data_3.map((item: testimonialDataItem) => (
                <div key={item.id} className="tp-test-s-item">
                  <div className="tp-testi tp-testi-round p-relative">
                    <div className="tp-testi__ava testi-ava-border d-flex align-items-center mb-20 pb-20">
                      <img
                        src={style_about ? item?.img_about : item.img}
                        alt="testi-avatar"
                      />
