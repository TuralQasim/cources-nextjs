...
const about_info: AboutInfoType = {
  students: "235K",
  review: "4.7",
  pro_courses: "3.5K",
  ...
  des: (
    <>
      {" "}
      Dramatically supply transparent deliverables befoe backward comp internal
      or "organic" sources.
    </>
  ),
};
...
type AboutListDataItem = {
  name: string;
};
const about_list_data: AboutListDataItem[] = [
  {
...
const AboutArea: React.FC<AboutAreaProps> = ({ style_about }) => {
  return (
    <>
      <section
            ...
            <div className="col-xxl-5 col-xl-5 col-lg-6 col-md-12 col-12">
              <div className="tp-about-class-content mb-50 ml-75">
                ...
                <div className="tp-about-list mb-65">
                  <ul>
                    {about_list_data.map(
                      (item: AboutListDataItem, i: number) => (
                        <li key={i}>
