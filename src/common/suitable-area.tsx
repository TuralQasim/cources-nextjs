...
// suitable_data
const suitable_data: suitableDataItem[] = [
  {
    id: 1,
    title: (
      <>
...
type SuitableAreaProps = {
  style_2: boolean;
};
const SuitableArea: React.FC<SuitableAreaProps> = ({ style_2 }) => {
  return (
    <>
      <section
      ...
      >
        <div className="container">
          ...
          <div className="row">
            {suitable_data.map((item: suitableDataItem) => (
