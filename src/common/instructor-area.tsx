...
// instructor_info
const instructor_info: instructorInfoItem[] = [
  {
    id: 1,
...
type InstructorAreaProps = {
  style_2: boolean;
};
const InstructorArea: React.FC<InstructorAreaProps> = ({ style_2 }) => {
        ...
        <div className="container">
          ...
          <div className="intruc-active mb-15 tp-slide-space">
            <Slider {...setting} ref={sliderRef}>
              {instructor_info.map((item: instructorInfoItem) => (
